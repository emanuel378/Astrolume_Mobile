...
export default function Questao7() {
  ...
  const explicacoes = {
    "16":
      "16 seria o resultado de 8 + 8. Verifique a soma novamente.",
    "20":
      "20 é maior que o resultado correto. Tente refazer a conta."
  };
      ...
      <div className="questao-container">
        ...
        <div className="question-box">
          ...
          <div className="options">
            ...
            <button onClick={() => verificarResposta("16")}>
              A) 16
            </button>

            <button onClick={() => verificarResposta("18")}>
              B) 18
            </button>

            <button onClick={() => verificarResposta("20")}>
              C) 20
            </button>
